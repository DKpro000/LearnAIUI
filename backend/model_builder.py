...
class GeneratedGraphModel(nn.Module):
    def __init__(self, graph: dict, execution_order: list[str]):
        ...
        self.modules_by_node_id = nn.ModuleDict()
        ...
        for node_id in execution_order:
            ...
            if node_kind == "ModuleNode":
                module = instantiate_module_node(node)
                self.modules_by_node_id[node_id] = module

            elif node_kind == "ContainerNode":
                module = instantiate_container_node(node)
                self.modules_by_node_id[node_id] = module
    ...
    def forward(self, x):
        ...
        for node_id in self.execution_order:
            ...
            if node_kind == "DatasetNode":
                ...
                module = self.modules_by_node_id[node_id]
