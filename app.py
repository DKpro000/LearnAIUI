...
from checkpoint_manager import list_checkpoints, delete_checkpoint
...
@app.get("/checkpoints")
def checkpoints(dataset_name: str = "", model_name: str = ""):
    try:
...
def delete_checkpoint_endpoint(checkpoint_id: str):
    try:
